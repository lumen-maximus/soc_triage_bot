...
from ..models import Signal, Classification, Action, EnrichmentResult
...
class ReportService:
    ...
    def _get_template(self) -> str:
        ...
        if self.env:
            try:
                return self.env.get_template("triage_report.md.j2").source
            except Exception:
                pass
        
        # Default inline template
        return """# Security Signal Triage Report
