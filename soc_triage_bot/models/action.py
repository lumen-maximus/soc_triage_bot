...
class Action(BaseModel):
    ...
    steps: List[str] = Field(
        ...
        description="Steps to execute the action"
    )
    
    # Context
    reasoning: str
    source: str = Field(..., description="How action was generated: template/learned/generated")
    ...
    related_entities: Dict[str, List[str]] = Field(
        ...
        description="Entities this action targets"
    )
